define(["exports", "./States", "fable-core/umd/Seq", "./Utility", "fable-core/umd/RegExp", "fable-core/umd/Map", "fable-core/umd/List", "./Identifier", "fable-core/umd/String"], function (exports, _States, _Seq, _Utility, _RegExp, _Map, _List, _Identifier, _String) {
    "use strict";
    ...
    exports.makeEnumeratedList = makeEnumeratedList;
    exports.makeUnorderedList = makeUnorderedList;
    exports.makeBlockquote = makeBlockquote;
    exports.makeIndentationCodeblock = makeIndentationCodeblock;
    exports.makeFencedCodeblock = makeFencedCodeblock;
    ...
    function makeTableOfContent() {
        ...
        while (index < _States.headings.length) {
            ...
            {
                const link = "<a href='#" + eachHeading[2] + "' style='padding-left: " + (() => {
                    let copyOfStruct = 2 * eachHeading[1] - 1;
    ...
    function makeFootnoteRef(text) {
        ...
        const replace = inputString => {
            ...
            if (m != null) {
                ...
                const outputString = (0, _RegExp.replace)(inputString, occurancePattern, "<sup><a href='#footnote-" + footnoteIdentifier + "' id='" + footnoteIdentifier + "'>[" + footnoteIdentifier + "]</a></sup>");
                return replace(outputString);
            } else {
                return inputString;
            }
    ...
    function preProcess(stringList) {
        ...
        while (rowIndex <= stringList_1.length - 2) {
            ...
            {
                const activePatternResult169 = (0, _Identifier.$7C$IsHeadingLevelOne$7C$_$7C$)(nextRow);
                ...
                if (activePatternResult169 != null) {
                    ...
                    const activePatternResult168 = (0, _Identifier.$7C$IsHeadingLevelTwo$7C$_$7C$)(nextRow);

                    if (activePatternResult168 != null) {
                        const activePatternResult167 = (0, _Identifier.$7C$IsHeading$7C$_$7C$)(thisRow);

                        if (activePatternResult167 != null) {
                            outputList = new _List2.default(thisRow, outputList);
                        } else {
                            const activePatternResult166 = (0, _Identifier.$7C$IsAltHeading$7C$_$7C$)(thisRow);

                            if (activePatternResult166 != null) {
                                outputList = new _List2.default(thisRow, outputList);
                            } else {
                                const activePatternResult165 = (0, _Identifier.$7C$IsBlankLine$7C$_$7C$)(thisRow);
    ...
    function makeEnumeratedList(items) {
        const outputHtml = makeEmphasis((0, _Seq.fold)((x, y) => x + y, "", (0, _List.map)(x => "<li>" + x + "</li>", items)));
        return "<ol>" + outputHtml + "</ol>";
    }

    function makeUnorderedList(items) {
        const outputHtml = makeEmphasis((0, _Seq.fold)((x, y) => x + y, "", (0, _List.map)(x => "<li>" + x + "</li>", items)));
        return "<ul>" + outputHtml + "</ul>";
    }

    function makeBlockquote(items) {
        const outputHtml = makeEmphasis((0, _String.join)("<br>", items));
        return "<blockquote>" + outputHtml + "</blockquote>";
    }

    function makeIndentationCodeblock(items) {
        const outputHtml = (0, _String.join)("\n", items);
        return "<pre><code>" + outputHtml + "</pre></code>";
    }

    function makeFencedCodeblock(languageID, items) {
        const outputHtml = (0, _String.join)("\n", items);
        return "<pre><code class='" + languageID + "'>" + outputHtml + "</pre></code>";
    }
