define(["exports", "./Utility", "fable-core/umd/RegExp", "./Types", "fable-core/umd/Seq", "fable-core/umd/List", "fable-core/umd/String"], function (exports, _Utility, _RegExp, _Types, _Seq, _List, _String) {
    ...
    exports.$7C$IsCommentLine$7C$_$7C$ = exports.$7C$IsIndentationCodeblock$7C$_$7C$ = exports.$7C$IsBlockquoteLine$7C$_$7C$ = exports.$7C$IsEnumeratedList$7C$_$7C$ = exports.$7C$IsPipeTableRow$7C$_$7C$ = exports.$7C$IsLazyQuoteBody$7C$_$7C$ = exports.$7C$IsExcelTableRow$7C$_$7C$ = exports.$7C$IsCollapesEnd$7C$_$7C$ = exports.$7C$IsCollapesStart$7C$_$7C$ = exports.$7C$IsCodeBlockEnd$7C$_$7C$ = exports.$7C$IsFlowChartStart$7C$_$7C$ = exports.$7C$IsCodeBlockStart$7C$_$7C$ = exports.$7C$IsBlockQuoteLine$7C$_$7C$ = exports.$7C$IsBlockQuoteStart$7C$_$7C$ = exports.$7C$IsFootnote$7C$_$7C$ = exports.$7C$IsLinkRef$7C$_$7C$ = exports.$7C$IsTableOfContent$7C$_$7C$ = exports.$7C$IsAltHeading$7C$_$7C$ = exports.$7C$IsHeadingLevelTwo$7C$_$7C$ = exports.$7C$IsHeadingLevelOne$7C$_$7C$ = exports.$7C$IsHeading$7C$_$7C$ = exports.$7C$IsHorizontalRuleLine$7C$_$7C$ = exports.$7C$IsBlankLine$7C$_$7C$ = undefined;

    function _IsBlankLine___(line) {
        const pattern = "^ {0,3}$";
    ...
    function _IsLazyQuoteBody___(line) {
        const pattern = "^ {0,3}(.+)";
        return (0, _Utility.firstRegexGroup)(pattern, line);
    }

    exports.$7C$IsLazyQuoteBody$7C$_$7C$ = _IsLazyQuoteBody___;
    ...
    function _IsEnumeratedList___(line) {
        const pattern = "^ {0,3}\\d+\\. *(.+)";
        return (0, _Utility.firstRegexGroup)(pattern, line);
    }

    exports.$7C$IsEnumeratedList$7C$_$7C$ = _IsEnumeratedList___;
    ...
    function _IsIndentationCodeblock___(line) {
        const pattern = "^(?: {4}|\t)(.*)";
        return (0, _Utility.firstRegexGroup)(pattern, line);
    }

    exports.$7C$IsIndentationCodeblock$7C$_$7C$ = _IsIndentationCodeblock___;

    function _IsCommentLine___(line) {
        const pattern = "^ {0,3}//(.*)";
        return (0, _Utility.firstRegexGroup)(pattern, line);
    }

    exports.$7C$IsCommentLine$7C$_$7C$ = _IsCommentLine___;
});
